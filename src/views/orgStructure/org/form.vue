<template>
  <a-drawer :title="title" width="720" :visible="state.visible" @close="close" :body-style="{ paddingBottom: '80px' }">
              ...
              v-decorator="[
                'code',
                {
                  ...
                  rules: [
                    ...
                    { max: 50, message: '50字符以内', whitespace: true },
            ...
            <a-input
              ...
              v-decorator="[
                'name',
                {
                  ...
                  rules: [
                    { required: true, message: '全称不能为空', whitespace: true },
                    { max: 50, message: '50字符以内', whitespace: true },
                  ],
                },
              ]"
            ...
            <a-input
              ...
              v-decorator="[
                'shortName',
                {
                  ...
                  rules: [
                    { required: true, message: '简称不能为空', whitespace: true },
                    { max: 50, message: '50字符以内', whitespace: true },
                  ],
                },
              ]"
      ...
      <a-row :gutter="16">
        <a-col :span="12">
          <a-form-item label="类型">
            ...
            >
              <a-select-option v-for="(type, index) in more.orgTypeOptions" :key="index" :value="type.value">
                {{ type.label }}
              </a-select-option>
            </a-select>
          </a-form-item>
            ...
            <a-input
              ...
              v-decorator="[
                'managerId',
                {
                  ...
                  rules: [{ max: 50, message: '50字符以内', whitespace: true }],
                },
              ]"
            />
            ...
            <a-textarea
              ...
              v-decorator="[
                'orgComment',
                {
                  ...
                  rules: [{ max: 500, message: '500字符以内', whitespace: true }],
                },
              ]"
            />
          </a-form-item>
