<template>
  <a-drawer :title="title" width="420" :visible="state.visible" @close="close" :body-style="{ paddingBottom: '80px' }">
    <a-form :form="form">
      ...
      <a-form-item label="职级" :label-col="{ span: 5 }" :wrapper-col="{ span: 18 }">
        <a-select
          ...
          placeholder="请选择职级"
        >
          <a-select-option v-for="item in more.positionGradeOptions" :key="item.value" :value="item.value">
            {{ item.label }}
          </a-select-option>
        </a-select>
      </a-form-item>
      ...
      <a-form-item label="数据权限" :label-col="{ span: 5 }" :wrapper-col="{ span: 18 }">
        ...
        >
          <a-select-option v-for="item in more.dataPermissionTypeOptions" :key="item.value" :value="item.value">
            {{ item.label }}
          </a-select-option>
        </a-select>
      </a-form-item>
