  ...
  <a-card :bordered="false">
        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="用户类型">
              <a-input @keyup.enter.native="onSearch" allowClear placeholder="IamUser" v-model="queryParam.userType" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="业务对象">
              <a-input @keyup.enter.native="onSearch" allowClear placeholder="" v-model="queryParam.businessObj" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="状态">
              <a-select @change="onSearch" allowClear placeholder="选择" default-value="" v-model="queryParam.status">
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        ...
        <span v-permission-missing="['detail']"> - </span>
      </span>
    </a-table>
