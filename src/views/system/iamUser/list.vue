<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="姓名">
              <a-input @keyup.enter.native="onSearch" allowClear placeholder="姓名" v-model="queryParam.realname" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="状态">
              <a-select @change="onSearch" allowClear placeholder="请选择" default-value="" v-model="queryParam.status">
          ...
          <a-col :lg="3" :sm="24" style="text-align: right">
            <a-button v-action:create type="primary" icon="plus" @click="$refs.form.open(undefined)">新增</a-button>
          </a-col>
        </a-row>
      </a-form>
    </div>
    ...
    <!--表单页抽屉-->
    <diboot-form ref="form" :current-node-id="currentNodeId" @complete="getList"></diboot-form>
    <!--详情页抽屉-->
