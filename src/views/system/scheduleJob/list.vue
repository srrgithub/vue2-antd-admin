        ...
        <a-row :gutter="18">
          <a-col :md="8" :sm="24">
            <a-form-item label="任务">
              <a-input v-model="queryParam.jobName" allowClear @keyup.enter.native="onSearch" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="状态">
              <a-select @change="onSearch" v-model="queryParam.jobStatus" allowClear placeholder="请选择状态">
                <a-select-option value="A"> 启用 </a-select-option>
                <a-select-option value="I"> 停用 </a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
